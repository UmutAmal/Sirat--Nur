...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get playSurahAudio => 'Възпроизвеждане на аудио сура';

  @override
  String get pauseSurahAudio => 'Поставяне на аудио сура на пауза';
  ...
  String shareAppMessage(String appName, String url) {
    return 'Вижте $appName: Най-доброто приложение за ислямски начин на живот! $url';
  }
  ...
  @override
  String get checkingPremium => 'Премиум статусът се проверява...';
  ...
  @override
  String get quranIntegrity => 'Целостта на Корана';

  @override
  String get checkQuranDb => 'Проверете базата данни на Корана';

  @override
  String get verifyQuranContent => 'Проверете 114 сури и 6236 аята.';
  ...
  @override
  String get notSeeded => 'Не семена';
  ...
  String surahsCount(Object count) {
    return 'Сура: $count (очаква се 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'Аят: $count (очаква се 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'Липсващ арабски: $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'Липсващ турски: $count';
  }

  @override
  String dbVersion(Object version) {
    return 'Версия на DB: $version';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'Проверката на Корана не бе успешна: $error';
  }
  ...
  @override
  String get fajrAngle => 'Ъгъл Фаджр';

  @override
  String get ishaAngle => 'Иша Ъгъл';
  ...
  String get rerunSetup =>
      'Стартирайте отново процеса на първоначална настройка.';
  ...
  String diagnosticsPrayerHybridSource(String sourceName, String madhab) {
    return '$sourceName метод с избрана от потребителя настройка $madhab Asr';
  }
  ...
  @override
  String get cancelDownloadAction => 'Отказ от изтеглянето';
  ...
  String get quranAudioPlaybackErrorWithConnectionHint =>
      'Неуспешно възпроизвеждане на аудио. Моля, проверете връзката си.';

  @override
  String quranAudioSourcesIncomplete(String available, String total) {
    return 'Потвърденият аудио пакет от Корана е непълен ($available/$total). Опитайте отново, след като аудио каталогът бъде актуализиран.';
  }
