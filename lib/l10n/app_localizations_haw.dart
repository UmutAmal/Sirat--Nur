...
class AppLocalizationsHaw extends AppLocalizations {
  ...
  @override
  String get revelationMedinan => 'Madinana';
  ...
  String shareAppMessage(String appName, String url) {
    return 'E nānā iā $appName: ʻO ka app ola Islam hope loa! $url';
  }
  ...
  String targetCount(Object target) {
    return 'Ka helu kuhi: $target';
  }

  @override
  String get tapToCount => 'Kaomi no ka helu ʻana';
  ...
  @override
  String get premiumNotFound => 'ʻAʻole i loaʻa ke kau inoa premium.';

  @override
  String premiumRefreshError(Object error) {
    return 'ʻAʻole hiki ke hōʻoluʻolu i ke kūlana inoa inoa: $error';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'ʻAʻole hiki ke nānā i ka Quran: $error';
  }
  ...
  @override
  String get apply => 'E noi i nā hoʻololi';
  ...
  String diagnosticsPrayerRegionalFallbackSource(String sourceName) {
    return 'Hoʻihoʻi ʻāina me $sourceName. E hōʻoia i nā manawa pule kūloko me kāu mosque a i ʻole ka mana hoʻomana mana.';
  }
