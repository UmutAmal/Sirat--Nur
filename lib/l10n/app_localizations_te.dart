...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get quran => 'ఖురాన్';

  @override
  String get qibla => 'ఖిబ్లా';

  @override
  String get zikr => 'జిక్ర్';
  ...
  @override
  String get nextPrayer => 'తదుపరి ప్రార్థన';
  ...
  @override
  String get surahs => 'సూరాలు';

  @override
  String get ayahs => 'అయాస్';
  ...
  @override
  String get namesOfAllah => 'అల్లాహ్ పేర్లు';

  @override
  String get liveTv => 'ప్రత్యక్ష టీవీ';

  @override
  String get watchLive => 'ప్రత్యక్ష ప్రసారం చూడండి';

  @override
  String get streamError => 'స్ట్రీమ్ లోపం';
  ...
  @override
  String get ibadahTracker => 'ఇబాదా ట్రాకర్';
  ...
  @override
  String get revelationMedinan => 'మదీనాన్';

  @override
  String get prayers => 'ప్రార్థనలు';
  ...
  @override
  String get weeklyProgress => 'వీక్లీ ప్రోగ్రెస్';

  @override
  String get monthlyProgress => 'నెలవారీ పురోగతి';
  ...
  @override
  String get qiblaDirection => 'ఖిబ్లా దిశ';
  ...
  @override
  String get turnDevice => 'కిబ్లాకు ఎదురుగా మీ పరికరాన్ని తిరగండి';
  ...
  @override
  String get onboarding1Title => 'Sirat-ı Nur కు స్వాగతం';

  @override
  String get onboarding1Desc =>
      'ప్రార్థన సమయాలు, ఖురాన్ మరియు మరిన్నింటి కోసం మీ పూర్తి ఇస్లామిక్ సహచర అనువర్తనం';

  @override
  String get onboarding2Title => 'ప్రార్థన సమయాలు';

  @override
  String get onboarding2Desc => 'మీ స్థానం ఆధారంగా ఖచ్చితమైన ప్రార్థన సమయాలు';

  @override
  String get onboarding3Title => 'ఖురాన్ & మరిన్ని';

  @override
  String get onboarding3Desc =>
      'ఖురాన్ చదవండి, మీ పఠనాన్ని ట్రాక్ చేయండి మరియు ఇస్లామిక్ కంటెంట్‌ను అన్వేషించండి';

  @override
  String get dhikrLibrary => 'ధిక్ర్ లైబ్రరీ';

  @override
  String get resetCounter => 'కౌంటర్ రీసెట్ చేయండి';

  @override
  String get changeTarget => 'లక్ష్యాన్ని మార్చండి';

  @override
  String get newTarget => 'కొత్త లక్ష్యం';

  @override
  String targetCount(Object target) {
    return 'లక్ష్య సంఖ్య: $target';
  }

  @override
  String get tapToCount => 'లెక్కించడానికి నొక్కండి';
  ...
  @override
  String get dailyChecklist => 'రోజువారీ చెక్‌లిస్ట్';

  @override
  String get qazaDebt => 'ఖాజా (అప్పు)';

  @override
  String get resetQazaData => 'Qaza డేటాను రీసెట్ చేయండి';

  @override
  String get resetQazaDebtQuestion => 'కాజా రుణాన్ని రీసెట్ చేయాలా?';
  ...
  @override
  String get dailyProgress => 'రోజువారీ పురోగతి';

  @override
  String get mandatoryPrayers => 'తప్పనిసరి ప్రార్థనలు';

  @override
  String get sunnahAndOthers => 'సున్నత్ & ఇతరులు';

  @override
  String get spiritualGrowth => 'ఆధ్యాత్మిక వృద్ధి';

  @override
  String get mandatoryDuty => 'తప్పనిసరి విధి';

  @override
  String get totalPrayers => 'మొత్తం ప్రార్థనలు';

  @override
  String get prayerDebt => 'ప్రార్థన ఋణం';

  @override
  String get fastingDebt => 'ఉపవాస ఋణం';
  ...
  @override
  String get premiumIntegrity => 'ప్రీమియం సమగ్రత';

  @override
  String get recheckPremium =>
      'ప్రీమియం సబ్‌స్క్రిప్షన్ స్థితిని మళ్లీ తనిఖీ చేయండి';

  @override
  String get syncStore =>
      'మీ ప్రీమియం సభ్యత్వాన్ని నిర్ధారించడానికి యాప్ స్టోర్‌తో సమకాలీకరించండి.';

  @override
  String get checkingPremium => 'ప్రీమియం స్థితిని తనిఖీ చేస్తోంది...';

  @override
  String get premiumVerified => 'ప్రీమియం సభ్యత్వం ధృవీకరించబడింది.';

  @override
  String get premiumNotFound => 'ప్రీమియం సబ్‌స్క్రిప్షన్ కనుగొనబడలేదు.';

  @override
  String premiumRefreshError(Object error) {
    return 'ప్రీమియం సబ్‌స్క్రిప్షన్ స్థితిని రిఫ్రెష్ చేయడం సాధ్యపడలేదు: $error';
  }
  ...
  @override
  String get quranIntegrity => 'ఖురాన్ సమగ్రత';

  @override
  String get checkQuranDb => 'ఖురాన్ డేటాబేస్ తనిఖీ చేయండి';

  @override
  String get verifyQuranContent =>
      '114 సూరాలను మరియు 6236 అయాలను ధృవీకరించండి.';

  @override
  String get checkingQuranDb => 'ఖురాన్ డేటాబేస్ తనిఖీ చేస్తోంది...';

  @override
  String get okLabel => 'సరే';

  @override
  String get incomplete => 'అసంపూర్ణమైనది';

  @override
  String get notSeeded => 'విత్తనం వేయలేదు';

  @override
  String get quranDbStatus => 'ఖురాన్ డేటాబేస్ స్థితి';
  ...
  String surahsCount(Object count) {
    return 'సూరాలు: $count (అంచనా 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'అయాలు: $count (అంచనా 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'అరబిక్ లేదు: $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'టర్కిష్ లేదు: $count';
  }

  @override
  String dbVersion(Object version) {
    return 'DB వెర్షన్: $version';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'ఖురాన్ తనిఖీ విఫలమైంది: $error';
  }
  ...
  @override
  String get compassSmoothing => 'కంపాస్ స్మూతింగ్';

  @override
  String get reduceSensorJitter =>
      'స్థిరమైన సూది కోసం సెన్సార్ జిట్టర్‌ను తగ్గించండి.';

  @override
  String get calibrationOffset => 'అమరిక ఆఫ్‌సెట్';

  @override
  String currentOffset(Object offset) {
    return 'ప్రస్తుత: $offset°';
  }

  @override
  String get manualCorrectionDesc =>
      'మీ దిక్సూచికి మాన్యువల్ కరెక్షన్ అవసరమైతే సర్దుబాటు చేయండి. సానుకూల విలువలు సవ్యదిశలో తిరుగుతాయి.';

  @override
  String get apply => 'మార్పులను వర్తింపజేయండి';

  @override
  String get resetOnboarding => 'పరిచయ సెటప్‌ని రీసెట్ చేయండి';

  @override
  String get rerunSetup => 'ప్రారంభ సెటప్ ప్రక్రియను మళ్లీ అమలు చేయండి.';
  ...
  @override
  String get diagnosticsUiAudioAssets => 'UI ఆడియో ఆస్తులు';
  ...
  String diagnosticsSupportedCount(String count) {
    return '$count మద్దతు ఉంది';
  }

  @override
  String get diagnosticsQuranDataset => 'ఖురాన్ డేటాసెట్';

  @override
  String get diagnosticsQuranSurahs => 'ఖురాన్ సూరాలు';

  @override
  String get diagnosticsQuranAyahs => 'ఖురాన్ అయాలు';

  @override
  String get diagnosticsQuranJuzMetadata => 'ఖురాన్ జుజ్ మెటాడేటా';
  ...
  String diagnosticsQuranCloudCheckFailed(String error) {
    return 'క్లౌడ్ తనిఖీ విఫలమైంది: $error';
  }
  ...
  String diagnosticsQuranCloudStructuralCheckFailed(String error) {
    return 'క్లౌడ్ స్ట్రక్చరల్ చెక్ విఫలమైంది: $error';
  }

  @override
  String get healthCheckDesc =>
      'ఆరోగ్య తనిఖీలను అమలు చేయండి మరియు సిస్టమ్ స్థితిని వీక్షించండి.';

  @override
  String get qiblaAligned => 'ఖిబ్లా సమలేఖనం చేయబడింది';

  @override
  String get rotateToFindQibla => 'ఖిబ్లాను కనుగొనడానికి తిప్పండి';

  @override
  String get calibrationRequiredFigure8 =>
      'క్రమాంకనం అవసరం. ఫిగర్-8లో పరికరాన్ని తిప్పండి.';
  ...
  String get chatbotGreeting =>
      'అస్సలాము అలైకుమ్! నేను మీ ఇస్లామిక్ సహాయకుడిని. ప్రార్థన, ఉపవాసం, జకాత్ లేదా ఏదైనా ఇస్లామిక్ అంశం గురించి నన్ను అడగండి.';
  ...
  @override
  String get offlineQuranAudioPacks => 'ఆఫ్‌లైన్ ఖురాన్ ఆడియో ప్యాక్‌లు';

  @override
  String storedOnDeviceMb(String size) {
    return 'పరికరంలో నిల్వ చేయబడింది: $size MB';
  }
  ...
  String deletedOfflineFilesForReciter(String reciter) {
    return '$reciter కోసం ఆఫ్‌లైన్ ఫైల్‌లు తొలగించబడ్డాయి.';
  }
  ...
  String get quranAudioPlaybackErrorWithConnectionHint =>
      'ఆడియో ప్లేబ్యాక్ విఫలమైంది. దయచేసి మీ కనెక్షన్‌ని తనిఖీ చేయండి.';
  ...
  @override
  String get chatbotHint => 'ఒక ప్రశ్న అడగండి...';

  @override
  String get chatbotThinking => 'ఆలోచిస్తూ...';

  @override
  String get sukunMixerSubtitle => 'ప్రకృతి & ఖురాన్ మిక్సర్';

  @override
  String get audioPlayFailed => 'ఆడియో ప్లేబ్యాక్ విఫలమైంది';
