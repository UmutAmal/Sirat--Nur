...
class AppLocalizationsBe extends AppLocalizations {
  ...
  String get quranLoadFailed =>
      'Не ўдалося загрузіць змест Карана. Калі ласка, паспрабуйце яшчэ раз.';
  ...
  @override
  String get revelationMedinan => 'Медынан';
  ...
  String shareAppMessage(String appName, String url) {
    return 'Праверце $appName: найлепшае прыкладанне для ісламскага ладу жыцця! $url';
  }
  ...
  @override
  String get dhikrLibrary => 'Бібліятэка Зікр';

  @override
  String get resetCounter => 'Скінуць лічыльнік';

  @override
  String get changeTarget => 'Змяніць мэта';

  @override
  String get newTarget => 'Новая мэта';

  @override
  String targetCount(Object target) {
    return 'Мэтавая колькасць: $target';
  }

  @override
  String get tapToCount => 'Націсніце, каб палічыць';
  ...
  @override
  String get dailyChecklist => 'Штодзённы кантрольны спіс';

  @override
  String get qazaDebt => 'Каза (доўг)';

  @override
  String get resetQazaData => 'Скінуць даныя Qaza';

  @override
  String get resetQazaDebtQuestion => 'Скінуць доўг Qaza?';
  ...
  @override
  String get dailyProgress => 'Штодзённы прагрэс';

  @override
  String get mandatoryPrayers => 'Абавязковыя малітвы';

  @override
  String get sunnahAndOthers => 'Сунна і іншыя';

  @override
  String get spiritualGrowth => 'Духоўны рост';

  @override
  String get mandatoryDuty => 'Абавязковая павіннасць';

  @override
  String get totalPrayers => 'Агульныя малітвы';

  @override
  String get prayerDebt => 'Малітва Доўг';

  @override
  String get fastingDebt => 'Посны доўг';

  @override
  String get reset => 'Скінуць';

  @override
  String get days => 'дзён';

  @override
  String get premiumIntegrity => 'Прэміум Сумленнасць';

  @override
  String get recheckPremium => 'Праверце статус прэміум-падпіскі';

  @override
  String get syncStore =>
      'Сінхранізуйце з крамай прыкладанняў, каб пацвердзіць сваю прэміум-падпіску.';

  @override
  String get checkingPremium => 'Праверка прэміум-статусу...';

  @override
  String get premiumVerified => 'Прэміум-падпіска пацверджана.';

  @override
  String get premiumNotFound => 'Прэміум-падпіска не знойдзена.';

  @override
  String premiumRefreshError(Object error) {
    return 'Не ўдалося абнавіць статус прэміум-падпіскі: $error';
  }
  ...
  @override
  String get quranIntegrity => 'Цэласнасць Карана';

  @override
  String get checkQuranDb => 'Праверце базу дадзеных Карана';

  @override
  String get verifyQuranContent => 'Праверце 114 сур і 6236 аятаў.';

  @override
  String get checkingQuranDb => 'Праверка базы дадзеных Карана...';

  @override
  String get okLabel => 'добра';

  @override
  String get incomplete => 'Няпоўная';

  @override
  String get notSeeded => 'Не пасеяны';

  @override
  String get quranDbStatus => 'Статус базы дадзеных Карана';
  ...
  String surahsCount(Object count) {
    return 'Сура: $count (чакаецца 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'Аяты: $count (чакаецца 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'Адсутнічае арабская: $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'Адсутнічае турэцкая: $count';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'Збой праверкі Карана: $error';
  }
  ...
  @override
  String get compassSmoothing => 'Згладжванне компасам';

  @override
  String get reduceSensorJitter =>
      'Паменшыце дрыгаценне датчыка для больш устойлівай іголкі.';

  @override
  String get calibrationOffset => 'Зрушэнне каліброўкі';
  ...
  String get manualCorrectionDesc =>
      'Адрэгулюйце, калі ваш компас патрабуе карэкцыі ўручную. Дадатныя значэнні круцяцца па гадзіннікавай стрэлцы.';

  @override
  String get apply => 'Прымяніць змены';

  @override
  String get resetOnboarding => 'Скінуць уступныя налады';

  @override
  String get rerunSetup => 'Паўтарыце працэс першапачатковай наладкі.';
  ...
  String get healthCheckDesc =>
      'Запускайце праверкі стану і праглядайце стан сістэмы.';

  @override
  String get qiblaAligned => 'Выраўнаваная Кібла';

  @override
  String get rotateToFindQibla => 'Павярніце, каб знайсці Qibla';

  @override
  String get calibrationRequiredFigure8 =>
      'Патрабуецца каліброўка. Павярніце прыладу на малюнку-8.';
  ...
  String get chatbotGreeting =>
      'Ассаламу алейкум! Я твой ісламскі памочнік. Спытайце мяне пра малітву, пост, закят або любую ісламскую тэму.';
  ...
  String downloadingSurah(String surah, String total) {
    return 'Спампоўка суры $surah / $total';
  }
  ...
  @override
  String get offlineQuranAudioPacks => 'Афлайн-аўдыяпакеты Карана';

  @override
  String storedOnDeviceMb(String size) {
    return 'Захавана на прыладзе: $size MB';
  }

  @override
  String downloadedSurahProgress(String downloaded, String total) {
    return 'Спампавана $downloaded / $total сур';
  }

  @override
  String get redownloadMissingRepair => 'Адрамантаваць / спампаваць Адсутнічае';
  ...
  String deletedOfflineFilesForReciter(String reciter) {
    return 'Выдалены пазасеткавыя файлы для $reciter.';
  }
  ...
  @override
  String get chatbotHint => 'Задайце пытанне...';

  @override
  String get chatbotThinking => 'Думаючы...';

  @override
  String get sukunMixerSubtitle => 'Прырода і Каран Mixer';

  @override
  String get audioPlayFailed => 'Памылка прайгравання аўдыя';
  ...
  String distanceAwayKm(String distance) {
    return 'на адлегласці $distance км';
  }
