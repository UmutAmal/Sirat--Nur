...
class AppLocalizationsMai extends AppLocalizations {
  ...
  @override
  String get playSurahAudio => 'सूरह ऑडियो बजाउ';

  @override
  String get pauseSurahAudio => 'सूरह ऑडियो विराम करू';
  ...
  String shareAppMessage(String appName, String url) {
    return 'देखू $appName: परम इस्लामी जीवनशैली ऐप! $url के।';
  }
  ...
  String diagnosticsPrayerRegionalFallbackSource(String sourceName) {
    return '$sourceName क उपयोग कए क्षेत्रीय फॉलबैक. स्थानीय नमाज के समय के पुष्टि अपन मस्जिद या आधिकारिक धार्मिक प्राधिकारी के संग करू।';
  }
  ...
  String get diagnosticsQuranCloudTablesMissing =>
      'Supabase मे क्लाउड टेबल गायब; बंडल फॉलबैक सक्रिय';
  ...
  String get chatbotGreeting =>
      'अस्सलामु अलैकुम ! हम अहाँक इस्लामी सहायक छी। हमरा स नमाज, रोजा, जकात, या कोनो इस्लामी विषय के बारे में पूछू।';
  ...
  @override
  String get cancelDownloadAction => 'डाउनलोड रद्द करू';
  ...
  String downloadCanceledForReciter(String reciter) {
    return '$reciter क लेल डाउनलोड रद्द कएल गेल.';
  }
  ...
  String get quranAudioSourcesUnavailable =>
      'सत्यापित कुरान ऑडियो स्रोत एखन अनुपलब्ध अछि।';

  @override
  String get quranAudioPlaybackErrorWithConnectionHint =>
      'ऑडियो प्लेबैक विफल भ गेल। कृपया अपन कनेक्शन देखू।';

  @override
  String quranAudioSourcesIncomplete(String available, String total) {
    return 'सत्यापित कुरान ऑडियो पैक अपूर्ण अछि ($available/$total)। ऑडियो कैटलॉग अपडेट भेलाक बाद फेरसँ प्रयास करू.';
  }

  @override
  String get chatbotHint => 'एकटा सवाल पूछू...';

  @override
  String get chatbotThinking => 'सोचि रहल छी...';
