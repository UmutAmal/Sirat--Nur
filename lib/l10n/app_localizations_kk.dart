...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get playSurahAudio => 'Сүре дыбысын ойнату';

  @override
  String get pauseSurahAudio => 'Сүре дыбысын кідірту';
  ...
  @override
  String get monthlyProgress => 'Айлық прогресс';
  ...
  String shareAppMessage(String appName, String url) {
    return '$appName қараңыз: Исламдық өмір салтын көрсететін соңғы қолданба! $url';
  }
  ...
  @override
  String get dhikrLibrary => 'Зикр кітапханасы';

  @override
  String get resetCounter => 'Есептегішті қалпына келтіру';

  @override
  String get changeTarget => 'Мақсатты өзгерту';

  @override
  String get newTarget => 'Жаңа мақсат';

  @override
  String targetCount(Object target) {
    return 'Мақсатты саны: $target';
  }
  ...
  @override
  String get dailyChecklist => 'Күнделікті бақылау тізімі';

  @override
  String get qazaDebt => 'Qaza (қарыз)';

  @override
  String get resetQazaData => 'Qaza деректерін қалпына келтіріңіз';

  @override
  String get resetQazaDebtQuestion => 'Qaza қарызын қалпына келтіру керек пе?';
  ...
  @override
  String get mandatoryPrayers => 'Міндетті дұғалар';

  @override
  String get sunnahAndOthers => 'Сүннет және басқалар';

  @override
  String get spiritualGrowth => 'Рухани өсу';

  @override
  String get mandatoryDuty => 'Міндетті міндет';

  @override
  String get totalPrayers => 'Жалпы дұғалар';

  @override
  String get prayerDebt => 'Намаз қарызы';

  @override
  String get fastingDebt => 'Ораза қарызы';

  @override
  String get reset => 'Қалпына келтіру';

  @override
  String get days => 'Күндер';

  @override
  String get premiumIntegrity => 'Премиум тұтастық';

  @override
  String get recheckPremium => 'Премиум жазылым күйін қайта тексеріңіз';

  @override
  String get syncStore =>
      'Премиум жазылымды растау үшін қолданбалар дүкенімен синхрондаңыз.';

  @override
  String get checkingPremium => 'Премиум күйі тексерілуде...';

  @override
  String get premiumVerified => 'Премиум жазылым расталды.';

  @override
  String get premiumNotFound => 'Премиум жазылым табылмады.';

  @override
  String premiumRefreshError(Object error) {
    return 'Премиум жазылым күйін жаңарту мүмкін болмады: $error';
  }
  ...
  @override
  String get quranIntegrity => 'Құранның тұтастығы';

  @override
  String get checkQuranDb => 'Құран деректер базасын тексеріңіз';

  @override
  String get verifyQuranContent => '114 сүре мен 6236 аятты растаңыз.';

  @override
  String get checkingQuranDb => 'Құран деректер базасын тексеру...';

  @override
  String get okLabel => 'Жарайды';

  @override
  String get incomplete => 'Аяқталмаған';

  @override
  String get notSeeded => 'Егілмеген';

  @override
  String get quranDbStatus => 'Құран деректер қорының күйі';
  ...
  String surahsCount(Object count) {
    return 'Сүрелер: $count (күтілетін 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'Аяттар: $count (күтілетін 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'Араб тілі жоқ: $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'Түрік тілі жоқ: $count';
  }

  @override
  String dbVersion(Object version) {
    return 'ДҚ нұсқасы: $version';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'Құран тексерілмеді: $error';
  }
  ...
  String get reduceSensorJitter =>
      'Тұрақты ине үшін сенсордың дірілін азайтыңыз.';
  ...
  @override
  String get apply => 'Өзгерістерді қолдану';

  @override
  String get resetOnboarding => 'Кіріспе параметрлерді қалпына келтіріңіз';

  @override
  String get rerunSetup => 'Бастапқы орнату процесін қайта іске қосыңыз.';
  ...
  String get healthCheckDesc =>
      'Денсаулықты тексеруді іске қосыңыз және жүйе күйін қараңыз.';

  @override
  String get qiblaAligned => 'Qibla тураланған';

  @override
  String get rotateToFindQibla => 'Қибланы табу үшін айналдырыңыз';
