...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get playSurahAudio => 'سورہ آڈیو چلائیں۔';

  @override
  String get pauseSurahAudio => 'سورہ آڈیو کو روکیں۔';

  @override
  String get revelationMeccan => 'مکہ';

  @override
  String get revelationMedinan => 'مدینہ';
  ...
  @override
  String get rateApp => 'اس ایپ کی درجہ بندی کریں۔';

  @override
  String get shareApp => 'اس ایپ کو شیئر کریں۔';
  ...
  @override
  String get dhikrLibrary => 'ذکر لائبریری';

  @override
  String get resetCounter => 'کاؤنٹر کو ری سیٹ کریں۔';

  @override
  String get changeTarget => 'ہدف تبدیل کریں۔';

  @override
  String get newTarget => 'نیا ہدف';

  @override
  String targetCount(Object target) {
    return 'ہدف کی تعداد: $target';
  }

  @override
  String get tapToCount => 'گننے کے لیے تھپتھپائیں۔';
  ...
  @override
  String get dailyChecklist => 'روزانہ چیک لسٹ';

  @override
  String get qazaDebt => 'قضا (قرض)';

  @override
  String get resetQazaData => 'قضا ڈیٹا کو دوبارہ ترتیب دیں۔';
  ...
  @override
  String get mandatoryPrayers => 'فرض نمازیں۔';

  @override
  String get sunnahAndOthers => 'سنت اور دیگر';

  @override
  String get spiritualGrowth => 'روحانی ترقی';

  @override
  String get mandatoryDuty => 'لازمی ڈیوٹی';

  @override
  String get totalPrayers => 'کل دعائیں';

  @override
  String get prayerDebt => 'نماز کا قرض';

  @override
  String get fastingDebt => 'روزہ قرض';
  ...
  @override
  String get premiumIntegrity => 'پریمیم سالمیت';

  @override
  String get recheckPremium => 'پریمیم رکنیت کی حیثیت کو دوبارہ چیک کریں۔';

  @override
  String get syncStore =>
      'اپنے پریمیم سبسکرپشن کی تصدیق کرنے کے لیے ایپ اسٹور کے ساتھ مطابقت پذیری کریں۔';

  @override
  String get checkingPremium => 'پریمیم اسٹیٹس چیک ہو رہا ہے...';

  @override
  String get premiumVerified => 'پریمیم سبسکرپشن کی تصدیق ہو گئی۔';

  @override
  String get premiumNotFound => 'پریمیم رکنیت نہیں ملی۔';

  @override
  String premiumRefreshError(Object error) {
    return 'پریمیم سبسکرپشن اسٹیٹس کو ریفریش نہیں کیا جا سکا: $error';
  }
  ...
  @override
  String get quranIntegrity => 'قرآن کی سالمیت';

  @override
  String get checkQuranDb => 'قرآن کا ڈیٹا بیس چیک کریں۔';

  @override
  String get verifyQuranContent => '114 سورتیں اور 6236 آیات کی تصدیق کریں۔';

  @override
  String get checkingQuranDb => 'قرآن کا ڈیٹا بیس چیک کر رہے ہیں...';

  @override
  String get okLabel => 'ٹھیک ہے';

  @override
  String get incomplete => 'نامکمل';

  @override
  String get notSeeded => 'سیڈ نہیں۔';

  @override
  String get quranDbStatus => 'قرآن ڈیٹا بیس کی حیثیت';
  ...
  String surahsCount(Object count) {
    return 'سورتیں: $count (متوقع 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'آیات: $count (متوقع 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'غائب عربی: $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'لاپتہ ترکی: $count';
  }

  @override
  String dbVersion(Object version) {
    return 'DB ورژن: $version';
  }
  ...
  @override
  String get compassSmoothing => 'کمپاس ہموار کرنا';

  @override
  String get reduceSensorJitter =>
      'ایک مستحکم سوئی کے لیے سینسر کے گھماؤ کو کم کریں۔';

  @override
  String get calibrationOffset => 'انشانکن آفسیٹ';

  @override
  String currentOffset(Object offset) {
    return 'موجودہ: $offset°';
  }

  @override
  String get manualCorrectionDesc =>
      'اگر آپ کے کمپاس کو دستی اصلاح کی ضرورت ہو تو ایڈجسٹ کریں۔ مثبت قدریں گھڑی کی سمت میں گھومتی ہیں۔';

  @override
  String get apply => 'تبدیلیاں لاگو کریں۔';

  @override
  String get resetOnboarding => 'انٹرو سیٹ اپ کو ری سیٹ کریں۔';

  @override
  String get rerunSetup => 'ابتدائی سیٹ اپ کے عمل کو دوبارہ چلائیں۔';
  ...
  String get diagnosticsPrayerCustomSource =>
      'دستی حسب ضرورت زاویہ (کوئی ادارہ جاتی ذریعہ نہیں)';
  ...
  String diagnosticsPrayerRegionalFallbackSource(String sourceName) {
    return '$sourceName کا استعمال کرتے ہوئے علاقائی فال بیک۔ اپنی مسجد یا سرکاری مذہبی اتھارٹی کے ساتھ مقامی نماز کے اوقات کی تصدیق کریں۔';
  }
  ...
  @override
  String get diagnosticsUiAudioAssets => 'UI آڈیو اثاثے۔';

  @override
  String get diagnosticsQuranAudioAssets => 'قرآن کے آڈیو اثاثے۔';
  ...
  String diagnosticsSupportedCount(String count) {
    return '$count تعاون یافتہ';
  }

  @override
  String get diagnosticsQuranDataset => 'قرآن ڈیٹاسیٹ';

  @override
  String get diagnosticsQuranSurahs => 'قرآن کی سورتیں۔';

  @override
  String get diagnosticsQuranAyahs => 'قرآنی آیات';

  @override
  String get diagnosticsQuranJuzMetadata => 'قرآن جوز میٹا ڈیٹا';
  ...
  String diagnosticsQuranCloudCheckFailed(String error) {
    return 'کلاؤڈ چیک ناکام ہو گیا: $error';
  }
  ...
  String diagnosticsQuranCloudStructuralCheckFailed(String error) {
    return 'کلاؤڈ ساختی چیک ناکام ہو گیا: $error';
  }

  @override
  String get healthCheckDesc => 'ہیلتھ چیکس چلائیں اور سسٹم کی صورتحال دیکھیں۔';

  @override
  String get qiblaAligned => 'قبلہ صف بندی';

  @override
  String get rotateToFindQibla => 'قبلہ تلاش کرنے کے لیے گھمائیں۔';

  @override
  String get calibrationRequiredFigure8 =>
      'انشانکن درکار ہے۔ ڈیوائس کو شکل 8 میں گھمائیں۔';
  ...
  String get chatbotGreeting =>
      'السلام علیکم! میں آپ کا اسلامی معاون ہوں۔ مجھ سے نماز، روزہ، زکوٰۃ، یا کسی اسلامی موضوع کے بارے میں پوچھیں۔';
  ...
  @override
  String get offlineQuranAudioPacks => 'آف لائن قرآن آڈیو پیک';

  @override
  String storedOnDeviceMb(String size) {
    return 'ڈیوائس پر اسٹور کردہ: $size MB';
  }
  ...
  @override
  String get cancelDownloadAction => 'ڈاؤن لوڈ منسوخ کریں۔';
  ...
  String deletedOfflineFilesForReciter(String reciter) {
    return '$reciter کے لیے آف لائن فائلیں حذف کر دی گئیں۔';
  }
  ...
  @override
  String get chatbotHint => 'ایک سوال پوچھیں...';

  @override
  String get chatbotThinking => 'سوچ رہا ہے...';

  @override
  String get sukunMixerSubtitle => 'فطرت اور قرآن مکسر';

  @override
  String get audioPlayFailed => 'آڈیو پلے بیک ناکام ہو گیا۔';
  ...
  String get chatbotLocalNoInfo =>
      '[OFFLINE] تصدیق شدہ مقامی اسلامی رہنمائی ابھی تک دستیاب نہیں ہے۔ حاصل کردہ جوابات کے لیے Cloud AI پر سوئچ کریں۔';
