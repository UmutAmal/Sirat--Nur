...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get duaMeaning1 =>
      'Άλλοι προσεύχονται, «Κύριέ μας, δώσε μας το καλό στον κόσμο και στο επέκεινα, και προστάτεψε μας από το μαρτύριο της φωτιάς».';

  @override
  String get duaMeaning2 =>
      'Ο Θεός δεν επιβαρύνει καμία ψυχή με περισσότερα από όσα μπορεί να αντέξει: ο καθένας κερδίζει ό,τι καλό έχει κάνει, και υποφέρει το κακό του - «Κύριε, μη μας αναγκάσεις αν ξεχάσουμε ή κάνουμε λάθη. Κύριε, μη μας φορτώνεις όπως φόρτωσες αυτούς που ήταν πριν από εμάς. Κύριε, μη μας φορτώνεις με περισσότερα από όσα έχουμε δύναμη να αντέξουμε. Συγχώρεσέ μας, συγχώρεσέ μας και ελέησέ μας. Είσαι ο Προστάτης μας, βοήθησέ μας λοιπόν ενάντια στους απίστους».';

  @override
  String get duaMeaning3 =>
      '«Κύριέ μας, μην αφήσεις τις καρδιές μας να παρεκκλίνουν αφού μας καθοδήγησες. Χάρισέ μας το έλεός Σου: Εσύ είσαι ο Πάντα Δίνοντας.';

  @override
  String get duaMeaning4 =>
      'Κύριε, δώσε εγώ και οι απόγονοί μου να συνεχίσουμε την προσευχή. Κύριε μας, δέξου το αίτημά μου.';

  @override
  String get duaMeaning5 =>
      'και χαμήλωσε το φτερό σου με ταπεινοφροσύνη απέναντί ​​τους με καλοσύνη και πες: «Κύριε, ελέησε τους, όπως με φρόντισαν όταν ήμουν μικρός».';

  @override
  String get duaMeaning6 =>
      'ύψιστος ο Θεός, αυτός που έχει αληθινά τον έλεγχο. [Προφήτη], μη βιαστείς να απαγγείλεις πριν ολοκληρωθεί η αποκάλυψη, αλλά πες, «Κύριε, αύξησέ με σε γνώση!»';

  @override
  String get duaMeaning7 =>
      'Πες [Προφήτης], “Κύριε, συγχώρεσε και ελέησε: Είσαι ο πιο ελεήμων από όλους”.';

  @override
  String get duaMeaning8 =>
      'όσοι προσεύχονται: «Κύριέ μας, δώσε μας χαρά για τους συζύγους και τους απογόνους μας». Κάντε μας καλά παραδείγματα για όσους σας γνωρίζουν».';
  ...
  @override
  String get islamicNewYear => 'Ισλαμική Πρωτοχρονιά';

  @override
  String get mawlidAnNabi => 'Mawlid an-Nabi';

  @override
  String get specialDayDateRamadanStart => '1 Ραμαζάνι';

  @override
  String get specialDayDateLaylatAlQadr => '27 Ραμαζάνι';

  @override
  String get specialDayDateEidAlFitr => '1 Σαουάλ';

  @override
  String get specialDayDateEidAlAdha => '10 Dhul Hijjah';

  @override
  String get specialDayDateIslamicNewYear => '1 Μουχαράμ';
  ...
  String targetCount(Object target) {
    return 'Πλήθος στόχων: $target';
  }

  @override
  String get tapToCount => 'Πατήστε για μέτρηση';
  ...
  @override
  String get dailyChecklist => 'Καθημερινή λίστα ελέγχου';

  @override
  String get qazaDebt => 'Qaza (Χρέος)';

  @override
  String get resetQazaData => 'Επαναφορά δεδομένων Qaza';

  @override
  String get resetQazaDebtQuestion => 'Επαναφορά του χρέους Qaza;';
  ...
  @override
  String get dailyProgress => 'Καθημερινή Πρόοδος';

  @override
  String get mandatoryPrayers => 'Υποχρεωτικές Προσευχές';

  @override
  String get sunnahAndOthers => 'Sunnah & Άλλοι';

  @override
  String get spiritualGrowth => 'Πνευματική Ανάπτυξη';

  @override
  String get mandatoryDuty => 'Υποχρεωτικό Καθήκον';

  @override
  String get totalPrayers => 'Ολικές Προσευχές';

  @override
  String get prayerDebt => 'Χρέος προσευχής';
  ...
  @override
  String get premiumNotFound => 'Η συνδρομή Premium δεν βρέθηκε.';

  @override
  String premiumRefreshError(Object error) {
    return 'Δεν ήταν δυνατή η ανανέωση της κατάστασης συνδρομής premium: $error';
  }
  ...
  String quranCheckFailed(Object error) {
    return 'Ο έλεγχος του Κορανίου απέτυχε: $error';
  }

  @override
  String get audioVoice => 'Φωνή ήχου';

  @override
  String get audioVoiceMisharyAlafasy => 'Άντρας (Mishary Alafasy)';
  ...
  @override
  String get apply => 'Εφαρμόστε αλλαγές';
  ...
  String get chatbotGreeting =>
      'Assalamu Alaikum! Είμαι ο ισλαμικός βοηθός σας. Ρωτήστε με για την προσευχή, τη νηστεία, το zakat ή οποιοδήποτε ισλαμικό θέμα.';
  ...
  @override
  String get chatbotHint => 'Κάντε μια ερώτηση...';

  @override
  String get chatbotThinking => 'Σκέφτομαι...';
