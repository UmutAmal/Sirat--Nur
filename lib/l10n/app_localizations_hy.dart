...
class AppLocalizationsHy extends AppLocalizations {
  ...
  @override
  String get revelationMedinan => 'Մեդինան';
  ...
  String shareAppMessage(String appName, String url) {
    return 'Ստուգեք $appName. Իսլամական ապրելակերպի վերջնական հավելվածը: $url';
  }
  ...
  String targetCount(Object target) {
    return 'Թիրախների քանակը՝ $target';
  }

  @override
  String get tapToCount => 'Հպեք՝ հաշվելու համար';
  ...
  @override
  String get dailyChecklist => 'Ամենօրյա ստուգաթերթ';

  @override
  String get qazaDebt => 'Քազա (պարտք)';

  @override
  String get resetQazaData => 'Վերականգնել Qaza Data-ը';

  @override
  String get resetQazaDebtQuestion => 'Վերակայե՞լ Քազայի պարտքը';
  ...
  @override
  String get dailyProgress => 'Ամենօրյա առաջընթաց';

  @override
  String get mandatoryPrayers => 'Պարտադիր աղոթքներ';

  @override
  String get sunnahAndOthers => 'Սուննա և այլք';

  @override
  String get spiritualGrowth => 'Հոգևոր աճ';

  @override
  String get mandatoryDuty => 'Պարտադիր պարտականություն';

  @override
  String get totalPrayers => 'Ընդհանուր աղոթքներ';

  @override
  String get prayerDebt => 'Աղոթքի պարտք';
  ...
  @override
  String get recheckPremium => 'Ստուգեք պրեմիում բաժանորդագրության կարգավիճակը';

  @override
  String get syncStore =>
      'Համաժամեցեք հավելվածների խանութի հետ՝ ձեր պրեմիում բաժանորդագրությունը հաստատելու համար:';

  @override
  String get checkingPremium => 'Պրեմիում կարգավիճակի ստուգում...';

  @override
  String get premiumVerified => 'Պրեմիում բաժանորդագրությունը հաստատված է:';

  @override
  String get premiumNotFound => 'Պրեմիում բաժանորդագրությունը չի գտնվել:';

  @override
  String premiumRefreshError(Object error) {
    return 'Չհաջողվեց թարմացնել պրեմիում բաժանորդագրության կարգավիճակը՝ $error';
  }
  ...
  @override
  String get quranIntegrity => 'Ղուրանի ամբողջականություն';

  @override
  String get checkQuranDb => 'Ստուգեք Ղուրանի տվյալների բազան';

  @override
  String get verifyQuranContent => 'Ստուգեք 114 սուրա և 6236 այա:';
  ...
  @override
  String get notSeeded => 'Սերմնավորված չէ';

  @override
  String get quranDbStatus => 'Ղուրանի տվյալների բազայի կարգավիճակը';

  @override
  String statusLabel(Object status) {
    return 'Կարգավիճակ՝ $status';
  }

  @override
  String surahsCount(Object count) {
    return 'Սուրաներ՝ $count (ակնկալվում է 114)';
  }

  @override
  String ayahsCount(Object count) {
    return 'Այաններ՝ $count (ակնկալվում է 6236)';
  }

  @override
  String missingArabic(Object count) {
    return 'Բացակայում է արաբերեն՝ $count';
  }

  @override
  String missingTurkish(Object count) {
    return 'Բացակայում է թուրքերեն՝ $count';
  }

  @override
  String dbVersion(Object version) {
    return 'DB տարբերակ՝ $version';
  }

  @override
  String dbPath(Object path) {
    return 'Ճանապարհ՝ $path';
  }
  ...
  @override
  String get apply => 'Կիրառել փոփոխությունները';

  @override
  String get resetOnboarding => 'Վերականգնել ներածական կարգավորումը';

  @override
  String get rerunSetup => 'Վերագործարկեք սկզբնական տեղադրման գործընթացը:';
  ...
  @override
  String get diagnosticsUiAudioAssets => 'UI աուդիո ակտիվներ';
  ...
  String diagnosticsSupportedCount(String count) {
    return '$count աջակցվում է';
  }

  @override
  String get diagnosticsQuranDataset => 'Ղուրանի տվյալների հավաքածու';

  @override
  String get diagnosticsQuranSurahs => 'Ղուրանի սուրաներ';

  @override
  String get diagnosticsQuranAyahs => 'Ղուրանի Այահներ';
  ...
  String diagnosticsQuranCloudCheckFailed(String error) {
    return 'Ամպային ստուգումը ձախողվեց՝ $error';
  }
  ...
  String diagnosticsQuranCloudStructuralCheckFailed(String error) {
    return 'Ամպի կառուցվածքի ստուգումը ձախողվեց՝ $error';
  }
  ...
  String get chatbotGreeting =>
      'Ասալամու Ալեյքում! Ես ձեր իսլամական օգնականն եմ: Հարցրեք ինձ աղոթքի, ծոմապահության, զաքաթի կամ որևէ իսլամական թեմայի մասին:';
  ...
  @override
  String get chatbotHint => 'Հարց տվեք...';

  @override
  String get chatbotThinking => 'Մտածելով...';
