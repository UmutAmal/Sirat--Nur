...
class AppLocalizationsBh extends AppLocalizations {
  ...
  String ayahsCount(Object count) {
    return 'अयाह: $count (6236 के उम्मीद बा)';
  }
  ...
  String dbVersion(Object version) {
    return 'डीबी संस्करण: $version बा।';
  }
  ...
  String get chatbotLocalNoInfo =>
      '[OFFLINE] सत्यापित स्थानीय इस्लामी मार्गदर्शन अभी तक उपलब्ध नइखे। स्रोत से मिलल जवाब खातिर क्लाउड एआई पर स्विच करीं।';
  ...
  String get placesDataSourceUnavailableBody =>
      'एह बिल्ड खातिर अबहिन ले कौनों सत्यापन कइल जगह डेटा एंडपॉइंट कॉन्फ़िगर नइखे कइल गइल। पास के खोज सक्षम करे से पहिले PLACES_OVERPASS_API_URL के कवनो मंजूर प्रॉक्सी भा प्रदाता पर सेट करीं।';
