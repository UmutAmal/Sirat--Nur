...
void main() {
  group('general ARB localization coverage', () {
    ...
    test('safe priority locales do not fall back to English for diagnostics asset copy', () {
    ...
    test('priority locales do not fall back to English for analytics and zakat labels', () {
      const localizedKeys = [
        'calculateZakat',
        'dayStreak',
        'bestStreak',
    ...
    test('priority locales do not fall back to English for places discovery copy', () {
      const localizedKeys = [
        'placesSearchArea',
        'nearbyMosques',
        'islamicSchools',
    ...
    test('priority locales do not fall back to English for qibla error copy', () {
      const localizedKeys = [
    ...
    test('priority locales do not fall back to English for zikr completion copy', () {
      const localizedKeys = [
        'zikrCompletedMashAllah',
      ];
    ...
    test('priority locales do not fall back to English for zikr meaning copy', () {
      const localizedKeys = [
    ...
    test('safe priority locales do not fall back to English for bundled asma meanings', () {
